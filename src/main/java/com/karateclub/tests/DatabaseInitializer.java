...
public class DatabaseInitializer {
    ...
    public static void initializeSampleData() {
        ...
        try {
            ...
            BeltRank whiteBelt = new BeltRank("White Belt", 50.0);
            BeltRank yellowBelt = new BeltRank( "Yellow Belt", 60.0);
            BeltRank orangeBelt = new BeltRank( "Orange Belt", 70.0);
            BeltRank greenBelt = new BeltRank( "Green Belt", 80.0);
            BeltRank blueBelt = new BeltRank( "Blue Belt", 90.0);
            BeltRank brownBelt = new BeltRank( "Brown Belt", 100.0);
            BeltRank blackBelt = new BeltRank( "Black Belt", 150.0);
            ...
            Person person1 = new Person( "John Doe", "123 Main St", "555-0101");
            Person person2 = new Person( "Jane Smith", "456 Oak Ave", "555-0102");
            Person person3 = new Person( "Mike Johnson", "789 Pine Rd", "555-0103");
            Person person4 = new Person( "Sarah Wilson", "321 Elm St", "555-0104");
            Person person5 = new Person( "Master Chen", "654 Maple Dr", "555-0105");
            Person person6 = new Person( "Sensei Yamada", "987 Birch Ln", "555-0106");
            ...
            Instructor instructor1 = new Instructor( person5, "5th Dan Black Belt");
            Instructor instructor2 = new Instructor( person6, "4th Dan Black Belt");
            ...
            Member member1 = new Member(person1, "Emergency: 555-9111", whiteBelt, true);
            Member member2 = new Member(person2, "Emergency: 555-9112", yellowBelt, true);
            Member member3 = new Member(person3, "Emergency: 555-9113", orangeBelt, true);
            Member member4 = new Member(person4, "Emergency: 555-9114", greenBelt, false);
            ...
            Payment payment1 = new Payment(100.0, LocalDate.now().minusDays(30), member1);
            Payment payment2 = new Payment(120.0, LocalDate.now().minusDays(15), member2);
            Payment payment3 = new Payment(80.0, LocalDate.now(), member3);
            ...
            BeltTest test1 = new BeltTest( member1, whiteBelt, true,
                    LocalDate.now().minusDays(60), instructor1, payment1);
            BeltTest test2 = new BeltTest( member2, yellowBelt, true,
                    LocalDate.now().minusDays(30), instructor2, payment2);
            BeltTest test3 = new BeltTest( member3, orangeBelt, false,
